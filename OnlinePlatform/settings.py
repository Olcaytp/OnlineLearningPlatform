...
USERDASHBOARD_TEMPLATE_DIR = BASE_DIR / 'UserDashboardApp' / 'templates'
...
SECRET_KEY = 'django-insecure-75k)2--0g$#i_$x@s0(ppo4!ak45g1cx%*vl)%pi#j!g96jgao'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            USERDASHBOARD_TEMPLATE_DIR #path to users dashboard templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
